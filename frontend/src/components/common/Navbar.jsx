...
import { UserPlus, LogIn, LogOut, LayoutDashboard, Menu, X, Sun, Moon } from 'lucide-react';
            ...
            <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <div className="flex justify-between items-center">
                    <Link to="/" className="flex items-center gap-2 text-xl font-bold text-gray-800 dark:text-gray-100">
                        <span className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Uni<span className="text-blue-600 dark:text-blue-400">Hub</span></span>
                    </Link>
